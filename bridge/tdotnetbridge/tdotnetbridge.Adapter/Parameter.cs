...
public struct Parameter
{
    ...
    public Type GetParameterType()
    {
        ...
        {
            var searchTypeName = TypeName;
            return AppDomain.CurrentDomain.GetAssemblies().Select(assembly => assembly.GetType(searchTypeName))
                .Where(type => type is not null).First();
        }
