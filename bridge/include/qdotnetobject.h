...
#define Q_DOTNET_OBJECT_REF_IMPL(T, ...)                         \
    T::T(std::nullptr_t) : QDotNetObject(nullptr) __VA_ARGS__ {} \
    T::T(const void* objectRef) : QDotNetObject(objectRef) __VA_ARGS__ {}

        // Copy ctor and assignment
#define Q_DOTNET_OBJECT_COPY_IMPL(T, ...)                        \
    T::T(const T& cpySrc) : QDotNetObject(cpySrc) __VA_ARGS__ {} \
...
#define Q_DOTNET_OBJECT_MOVE_IMPL(T, ...)                                       \
    T::T(T&& movSrc) noexcept : QDotNetObject(std::move(movSrc)) __VA_ARGS__ {} \
...
#define Q_DOTNET_OBJECT_REF_INLINE(T, ...)                    \
    T(std::nullptr_t) : QDotNetObject(nullptr) __VA_ARGS__ {} \
    T(const void* objectRef) : QDotNetObject(objectRef) __VA_ARGS__ {}

        // Copy ctor and assignment
#define Q_DOTNET_OBJECT_COPY_INLINE(T, ...)                   \
    T(const T& cpySrc) : QDotNetObject(cpySrc) __VA_ARGS__ {} \
...
#define Q_DOTNET_OBJECT_MOVE_INLINE(T, ...)                                  \
    T(T&& movSrc) noexcept : QDotNetObject(std::move(movSrc)) __VA_ARGS__ {} \
